...
contract StrategySpookyV2LP is StratManager, FeeManager {
    ...
    event ChargedFees(uint256 callFees, uint256 evolleFees, uint256 strategistFees);
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        uint256 nativeBal = IERC20(native).balanceOf(address(this)).mul(30).div(1000);
        ...
        emit ChargedFees(callFeeAmount, evolleFeeAmount, strategistFee);
    }
    ...
    function callReward() public view returns (uint256) {
        ...
        return nativeBal.mul(30).div(1000).mul(callFee).div(MAX_FEE);
    }
